...
df = spark.createDataFrame(data=[("1", "2019-06-24 12:01:19.000")], schema=["id", "input_timestamp"])
df.printSchema()
...
df.withColumn("timestamp", to_timestamp("input_timestamp").cast("string")).show(truncate=False)
