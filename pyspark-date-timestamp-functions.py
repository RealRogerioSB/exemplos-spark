...
from pyspark.sql.functions import (
    add_months, col, current_date, current_timestamp, date_add, date_format,
    date_sub, datediff, dayofmonth, dayofweek, dayofyear, hour, minute, month,
    months_between, next_day, second, to_date, to_timestamp, trunc, weekofyear,
    year
)
...
# to_timestamp()
df2.select(col("input"), to_timestamp(col("input"), "MM-dd-yyyy HH mm ss SSS").alias("to_timestamp")) \
    .show(truncate=False)
